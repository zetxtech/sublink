...
export const SubscribeLinks = (props) => {
    ...
    const copyToClipboardExpr = (text, copiedKey) => {
        const serializedText = JSON.stringify(text ?? '');
        const serializedKey = JSON.stringify(copiedKey);
        return `window.copyTextToClipboard(${serializedText}).then(() => { copied = ${serializedKey}; setTimeout(() => copied = null, 200); }).catch(() => {})`;
    };

    return (
        <div
            x-data="{ copied: null }"
            class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border-gray-100 dark:border-gray-700 p-6 mb-8 transition-all duration-300 hover:shadow-md"
        >
            ...
            <div class="space-y-4">
                ...
                <div class="relative group">
                    ...
                    <div class="flex gap-2">
                        <input
                            ...
                            readonly
                            value={links.xray}
                            class="w-full px-4 py-2 rounded-lg border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-900 text-gray-600 dark:text-gray-400 focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200 font-mono text-sm"
                        />
                        <button
                            type="button"
                            x-on:click={copyToClipboardExpr(links.xray, 'xray')}
                ...
                <div class="relative group">
                    ...
                    <div class="flex gap-2">
                        ...
                        <button
                            type="button"
                            x-on:click={copyToClipboardExpr(links.singbox, 'singbox')}
                            class="px-4 py-2 bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 rounded-lg hover:bg-green-100 dark:hover:bg-green-900/30 hover:text-green-600 dark:hover:text-green-400 transition-colors duration-200"
                ...
                <div class="relative group">
                    ...
                    <div class="flex gap-2">
                        ...
                        <button
                            type="button"
                            x-on:click={copyToClipboardExpr(links.clash, 'clash')}
                            class="px-4 py-2 bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 rounded-lg hover:bg-green-100 dark:hover:bg-green-900/30 hover:text-green-600 dark:hover:text-green-400 transition-colors duration-200"
                ...
                <div class="relative group">
                    ...
                    <div class="flex gap-2">
                        ...
                        <button
                            type="button"
                            x-on:click={copyToClipboardExpr(links.surge, 'surge')}
                            class="px-4 py-2 bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 rounded-lg hover:bg-green-100 dark:hover:bg-green-900/30 hover:text-green-600 dark:hover:text-green-400 transition-colors duration-200"
