...
export const translations = {
  'zh-CN': {
    ...
    shareUrls: '输入源',
    urlPlaceholder: '支持粘贴：分享链接、Clash 配置、Sing-Box 配置、Surge 配置...（每行一个）',
    ...
    subconverterConfigTitle: 'Subconverter 外部配置链接',
    ...
    UASettings: '自定义 UserAgent',
    UAtip: '留空表示使用请求 UserAgent',
    ...
    noHistory: '暂无历史记录',
    use: '使用',
    parseResultLink: '从结果链接解析',
    parseResultLinkTitle: '从结果链接反解析',
    parseResultLinkDescription: '粘贴任意已生成的订阅结果链接或短链接，恢复输入源和相关选项。',
    parseResultLinkPlaceholder: '例如：https://example.com/clash?... 或 https://example.com/c/abc123',
    parseNow: '解析',
    cancel: '取消',
    invalidSubscriptionUrl: '请输入有效的结果链接或短链接',
    parseConfigFailed: '解析结果链接失败',
    rawConfig: '原始配置',
  ...
  'en-US': {
    ...
    use: 'Use',
    parseResultLink: 'Parse Result Link',
    parseResultLinkTitle: 'Reverse Parse Result Link',
    parseResultLinkDescription: 'Paste any generated subscription result URL or short link to restore the input source and related options.',
    parseResultLinkPlaceholder: 'For example: https://example.com/clash?... or https://example.com/c/abc123',
    parseNow: 'Parse',
    cancel: 'Cancel',
    invalidSubscriptionUrl: 'Please enter a valid result URL or short link',
    parseConfigFailed: 'Failed to parse the result link',
  ...
  'fa': {
    ...
    parseResultLink: 'بازیابی از لینک نتیجه',
    parseResultLinkTitle: 'بازیابی از لینک نتیجه',
    parseResultLinkDescription: 'هر لینک نتیجه یا لینک کوتاه تولیدشده را جای‌گذاری کنید تا منبع ورودی و گزینه‌های مرتبط بازیابی شوند.',
    parseResultLinkPlaceholder: 'مثلاً: https://example.com/clash?... یا https://example.com/c/abc123',
    parseNow: 'بازیابی',
    cancel: 'انصراف',
    invalidSubscriptionUrl: 'لطفاً یک لینک نتیجه یا لینک کوتاه معتبر وارد کنید',
    parseConfigFailed: 'بازیابی لینک نتیجه ناموفق بود',
  ...
  'ru': {
    ...
    parseResultLink: 'Разобрать ссылку результата',
    parseResultLinkTitle: 'Обратный разбор ссылки результата',
    parseResultLinkDescription: 'Вставьте любую сгенерированную ссылку результата подписки или короткую ссылку, чтобы восстановить источник ввода и связанные параметры.',
    parseResultLinkPlaceholder: 'Например: https://example.com/clash?... или https://example.com/c/abc123',
    parseNow: 'Разобрать',
    cancel: 'Отмена',
    invalidSubscriptionUrl: 'Введите корректную ссылку результата или короткую ссылку',
    parseConfigFailed: 'Не удалось разобрать ссылку результата',
